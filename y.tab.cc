...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_GREATGREATAND = 12,             /* GREATGREATAND  */
...
{
       0,   241,   241,   245,   246,   250,   254,   255,   259,   260,
     264,   271,   282,   283,   287,   293,   294,   298,   305,   313,
     321,   331,   339,   351,   354
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREAT", "NEWLINE", "PIPE", "AMPERSAND", "LESS", "GREATAND",
  "GREATGREAT", "GREATGREATAND", "TWOGREAT", "$accept", "goal",
  "command_list", "command_line", "pipe_list", "command_and_args",
  "command_word", "argument_list", "argument", "io_modifier_list",
...
{
      10,    -4,    -6,    -6,     1,     9,    -6,     7,    -6,    -6,
      -6,    -6,    -6,    14,    -5,    15,    -6,    16,    -6,    17,
      18,    19,    20,    21,    -6,    22,    -6,    -6,    -6,    -6,
      -6,    -6,    -6,    -6,    -6
};
...
static const yytype_int8 yydefact[] =
{
       ...
       7,     1,     4,     0,    24,    10,     9,     0,    23,     0,
       0,     0,     0,     0,    15,     0,    14,    12,    17,    21,
      18,    19,    20,    22,     5
};
...
{
      17,    11,    10,    18,    19,    20,    21,    22,    23,    -2,
       1,     1,     2,     2,    13,     3,     3,     2,    26,    28,
      29,    30,    31,    32,    33,    16,     0,     0,    34,    12
};

static const yytype_int8 yycheck[] =
{
       5,     0,     6,     8,     9,    10,    11,    12,    13,     0,
       1,     1,     3,     3,     7,     6,     6,     3,     3,     3,
       3,     3,     3,     3,     3,    13,    -1,    -1,     6,     5
};
...
static const yytype_int8 yystos[] =
{
       ...
       6,     0,    17,     7,    23,    21,    19,     5,     8,     9,
      10,    11,    12,    13,    24,    25,     3,    22,     3,     3,
       3,     3,     3,     3,     6
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* command_line: pipe_list io_modifier_list background_opt NEWLINE  */
#line 251 "shell.y"
                        {
...
#line 1307 "y.tab.cc"
  ...
  case 10: /* command_and_args: command_word argument_list  */
#line 264 "shell.y"
                             {
...
#line 1362 "y.tab.cc"
  ...
  case 19: /* iomodifier_opt: GREATGREAT WORD  */
#line 313 "shell.y"
                    {
    if (Shell::_currentCommand._outFile != NULL) {
      printf("Ambiguous output redirect.\n");
...
#line 1375 "y.tab.cc"
  ...
  case 20: /* iomodifier_opt: GREATGREATAND WORD  */
#line 321 "shell.y"
                       {
    if (Shell::_currentCommand._outFile != NULL) {
      printf("Ambiguous output redirect.\n");
...
#line 1403 "y.tab.cc"
  ...
  case 22: /* iomodifier_opt: TWOGREAT WORD  */
#line 339 "shell.y"
                  {
...
#line 1417 "y.tab.cc"
  ...
  case 23: /* background_opt: AMPERSAND  */
#line 351 "shell.y"
            {
